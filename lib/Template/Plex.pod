...
Templates can be reused by way of inheritance and slots. A slot is like a place
holder which a child template can inject/override content in a  parent template

Multiple slots can be defined 
