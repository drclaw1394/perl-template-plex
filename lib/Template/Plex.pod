...
The 'lexical' part of this modules is the fact variables can be aliased into
the template (more on this below). It improves the style and use of variables
in the template. It also provides an alternative approach for modifying the
variables without rendering the template immediately
...
double quoted string. That's the hardest part of a template system... and perl
makes it free!
...
=head2 Unbalanced Delimiter Pairs
...
Currently L<Template::Plex> delimiter used is B<{ }>.  It isn't changeable in
this version.
...
Code is hosted on L<GitHub|http://github.com/drclaw1394/perl-template-plex>
